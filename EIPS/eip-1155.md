    ...
    "properties": {
        ...
        "localization": {
            ...
            "properties": {
                "uri": {
                    "type": "string",
                    "description": "The URI pattern to fetch localized data from. This URI should contain the substring `%l` which will be replaced with the appropriate locale value before sending the request."
                },
                "default": {
                    "type": "string",
...
```json
{
  ...
  "localization": {
    "uri": "ipfs://QmPvaEQFVvuiaYzkSVUp23iHTQeEUpDaJnP8U7C3PqE57w/%l.json",
    "default": "en",
    "locales": ["en", "es", "fr"]
  }
}
...
/**
    Note: The ERC-165 identifier for this interface is 0xe4dd2cbd.
*/
interface ERC1155ScopedApproval {
    ...
    */
    function getScopeCountForId(uint256 _id) external view returns (uint32);

    /**
        @notice             Returns a scope that contains _id.
        @param _id          The token ID
        @param _scopeIndex  The scope index to  query (valid values are 0 to getScopeCountForId(_id)-1)
        @return             The Nth scope containing the ID
    */
    function getScopeForId(uint256 _id, uint32 _scopeIndex) external view returns (bytes32);

    /**
        @notice Returns a URI that can be queried to get scope metadata. This URI should return a JSON document containing, at least the scope name and description.
        @param  _scope  The queried scope
        @return         The URI describing this scope.
    */
    function getScopeUri(bytes32 _scope) external view returns (string memory);
    ...
    /**
        ...
        @param _operator    Address to add to the set of authorized operators
        @param _scope       Approval scope (can be identified by calling getScopeForId)
        @param _approved    True if the operator is approved, false to revoke approval
    */
    ...
    /**
        ...
        @param _owner       The owner of the Tokens
        @param _operator    Address of authorized operator
        @param _scope       Scope to test for approval (can be identified by calling getScopeForId)
        @return             True if the operator is approved, false otherwise
    */
    function isApprovedForScope(address _owner, address _operator, bytes32 _scope) external view returns (bool);
}
```
</details>

<details>
<summary>Scope Metadata Schema</summary>
