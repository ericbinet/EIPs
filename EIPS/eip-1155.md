...
interface ERC1155ScopedApproval {
    ...
    */
    function getScopeCountForId(uint256 _id) public view returns (uint32);
    ...
    */
    function getScopeForId(uint256 _id, uint32 _scopeIndex) public view returns (bytes32);
    ...
    */
    function getScopeUri(bytes32 _scope) public view returns (string memory);
